            ...
            <div id="platform" class="zm-d-initial">
                <div class="row">
                    <div class="col-lg-12 d-flex justify-content-center">
						...
						<span class="zm-font-s_14 text-white zm-content-subtitle">untuk teknisi, tambahkan elemen game <br>ke 
						 dalam aplikasi tersebut dengan platform gamification Zoomin</span></span>
		...
		<div class="zm-content-three">
			<div class="row zm-mb_r-4">
				<div class="col-lg-12 zm-ma-1">
					<h1 class="zm-content-title zm-lh-20">15++ Elemen Game untuk Anda</h1>
				</div>
			</div>
				...
				<div class="col-lg-6">
     				<p class="zm-title zm-font-left text-justify">Dashboard untuk monitor dan mengatur sistem rewarding</p>
                        <div class="col-lg-3 d-md-block p-1 bg-danger"></div>
    						 <p class="zm-subtitle zm-mb_r-2 zm-font-left text-justify zm-pt-30 zm-pb-30">Anda dapat mengevaluasi kinerja masing-masing teknisi melalui dashboard. Selain itu, Anda juga dapat mengatur Mission dan Reward yang ingin Anda berikan kepada tim teknisi. Berikan 10 XP atau 20 XP, semua dapat Anda atur melalui dashboard</p>
       					</div>
		                <div class="col-md-6 d-flex align-items-left zm-xs-s_wrap_img zm-mb-50">
		                    <img class="zm-xs-s_wrap_img custom-w-h zm-mt_r--3 zm-pr-50 zm-mb-30" width="600" height="400" src="<?php echo base_url();?>dist/images/illustrations/platform-2.png" alt="dashboard zoomin untuk monitor dan konfigurasi">
		                </div>
			</div>
		</div>
